...
#define STRING_CONFIG_H_AUTHOR "(iamlayneb, Bender L3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bender L3 Pro"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "50bbd809-36f8-4cca-978c-52a324acec6a"
 ...
 */
// TODO: Consider disabling this if there are problems
...
#define DELAY_BEFORE_PROBING 175  // (ms) To prevent vibrations from triggering piezo sensors
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_USE_PROBE
    ...
    #define BED_TRAMMING_PROBE_TOLERANCE 0.06  // (mm)
...
//#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 141.14
  #define XY_DIAG_BD 140.86
  #define XY_SIDE_AD 105.03
  ...
  #define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC 141.76
    #define XZ_DIAG_BD 141.18
    #define XZ_DIAG_AD 100.08
    #define YZ_DIAG_AC 139.97
    #define YZ_DIAG_BD 139.93
    #define YZ_SIDE_AD 99.98
